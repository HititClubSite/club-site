...
app.post('/admin/settings',admin,async(req,res)=>{await write(settingsFile,{logo:req.body.logo||'/logo.png',whatsappUrl:req.body.whatsappUrl||'#',universityUrl:req.body.universityUrl||'#',welcomeTemplate:req.body.welcomeTemplate||''});res.redirect('/admin/panel')});
